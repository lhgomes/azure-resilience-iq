 ...
 * 
 * Generated: 2026-01-03T08:46:29.768Z
 */
...
export const AZURE_ICON_MANIFEST: IconManifest = {
  "ai + machine learning": [
  ...
  "compute": [
    ...
    "03487-icon-service-Compute-Fleet.svg",
  ...
  "new icons": [
    "029029174-icon-service-Load-Balancer-Hub.svg",
    ...
    "029636048-icon-service-Landing-Zone.svg",
    "029637767-icon-service-Service-Groups.svg",
    "029797391-icon-service-Engage-Center-Connect.svg",
    "02987-icon-service-pubsub.svg",
    "030486388-icon-service-Storage-Hubs.svg",
    "030777508 -icon-service-Service-Group-Relationships.svg",
    "030868929-icon-service-Stage-Maps.svg",
    "032130874-icon-service-Logic-Apps-Template.svg",
    "032487601-icon-service-AKS-Network-Policy.svg",
    "032869111-icon-service-Microsoft-Discovery.svg",
    "033049334-icon-service-Scheduled-Actions.svg",
    "033112809-icon-service-promethus.svg",
    "033545113-icon-service-Kubernetes-Hub.svg",
    "033745116-icon-service-Azure-Local.svg",
    "033805167-icon-service-Azure-App-Testing.svg",
    "03401-icon-service-Azure-Container-Storage.svg",
    "03425-icon-service-external-id.svg",
    "034251-icon-service-external-id-modified.svg",
    "034412066-icon-service-VNet-Appliance.svg",
    "034855501-icon-service-Monitor-Issues.svg",
    "03495-icon-service-Azure-Consumption-Commitment.svg",
    "03521-icon-service-Edge-Storage-Accelerator.svg",
    "035572279-icon-service-Operation-Center.svg",
    "03565-icon-service-SQL-Database-Fleet-Manager.svg",
    "03633-icon-service-Breeze.svg",
    "03643-icon-service-Network-Foundation-Hub.svg",
    "03645-icon-service-Azure-Linux.svg",
    "03650-icon-service-Network-Security-Hub.svg",
    "03656-icon-service-Hybrid-Connectivity-Hub.svg",
    "03675-icon-service-Azure-Managed-Redis.svg",
    "03687-icon-service-AI-at-Edge.svg",
    "03694-icon-service-VPNClientWindows.svg",
    "03755-icon-service-Planetary-Computer-Pro.svg"
  ],
  "other": [
